#!/usr/bin/env python3
"""Check that DeepPeak release metadata agrees across project files."""
...
def versions() -> dict[str, str]:
    ...
    return {
        ...
        "DeepPeak/_version.py": extract(
            r"^__version__\s*=\s*version\s*=\s*['\"]([^'\"]+)",
            ROOT / "DeepPeak" / "_version.py",
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--version", help="expected version, optionally prefixed with v"
    )
